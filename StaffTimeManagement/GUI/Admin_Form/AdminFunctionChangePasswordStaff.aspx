<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFunctionChangePasswordStaff.aspx.cs" Inherits="StaffTimeManagement.GUI.Admin_Form.AdminFunctionChangePasswordStaff" %>
...
<body>
    ...
    <div class="content">
        ...
        <tr>
            ...
            <td class="auto-style1">&nbsp;</td>
            <td>
                <asp:Button ID="ButtonCancel" runat="server" Text="CANCEL" OnClick="ButtonCancel_Click" style="height: 26px" />
