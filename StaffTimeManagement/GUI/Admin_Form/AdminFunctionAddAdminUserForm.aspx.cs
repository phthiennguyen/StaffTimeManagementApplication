...
{
    public partial class AdminFunctionAddAdminUserForm : System.Web.UI.Page
    {
        ...
        protected void ButtonNext_Click(object sender, EventArgs e)
        {
            ...
            User_Admin uS1 = new User_Admin();
            uS.UserName = TextBoxUsername.Text;

            if (uS1.GetUserAdminById(uS) != null)
            {
            ...
            uS1.AdminId = uS1.UserName;

            Session["userAdmin"] = uS1;
            Response.Redirect(@"\GUI\Admin_Form\AdminFunctionAddAdminForm.aspx");
        }
    }
}